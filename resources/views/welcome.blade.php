...
<body class="bg-white text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a
                href="{{ url('/dashboard') }}"
                class="inline-block px-5 py-2 text-white bg-blue-600 hover:bg-blue-700 border border-blue-600 hover:border-blue-700 rounded-md text-sm transition duration-200">
                Dashboard
            </a>
            @else
            <a
                href="{{ route('login') }}"
                class="inline-block px-5 py-2 text-blue-600 border border-blue-600 hover:bg-blue-50 rounded-md text-sm transition duration-200">
                Log in
            </a>
